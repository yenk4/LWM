...
# TRAIN VISION DEFAULT PARAMS:

#      --update_llama_config = "dict(theta=50000000,max_sequence_length=2048,
# use_flash_attention=True,scan_attention=True,scan_query_chunk_size=512,scan_key_chunk_size=1024,
# remat_attention='nothing_saveable',scan_mlp=True,scan_mlp_chunk_size=8192,remat_mlp='nothing_saveable',
# remat_block='nothing_saveable',scan_layers=True)" --tokenizer.vocab_file="$llama_tokenizer_path" \
